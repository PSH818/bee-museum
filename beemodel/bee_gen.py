...
#   exec(compile(open(r"<项目根>/beemodel/bee_gen.py", encoding="utf-8").read(), "bee_gen.py", "exec"))
...
def build_bee(preset="honeybee"):
    ...
    chitin = mat_new("chitin", p["col_chitin"], 0.45, sss=p["sss"])
    ...
    wb = get_bsdf(wingmat)
    wb.inputs["Base Color"].default_value = (0.85, 0.88, 0.92, 1)
